...
Problema de 2-SAT se poate rezolva apoi in complexitate de timp $O(|U| + |E|)$. Acest proces se poate simplifica in implementare
pentru ca in $C$ vor fi chiar acele noduri aflate la distanta impara de nodurile nesaturate din $U$.
